...
Depois, independente das escolhas anteriores, o usuário poderá escolher entre seguir se especializando
...
Por fim, perguntar quais são as tecnologias nas quais a pessoa gostaria de se especializar ou de 
...
let msg = prompt("Tem mais alguma tecnologia que você gostaria de aprender? Digite 'claro' em caso positivo. ");
while (msg === "claro"){
    let novaTecnologia = prompt("Qual? ");
    alert(`${novaTecnologia} é realmente uma tecnologia muito legal! `)
    msg = prompt("Tem mais alguma tecnologia que você gostaria de aprender? Digite 'claro' em caso positivo. ");
}
